...
dp_expbe
dp_expbe_al
# better to have these plots in a grid but they look weird like that.  We should put one legend on the side
...
This chunck provides a plots and informations about the clustering (number of cells per sample per cluster and mean values)
```{r}
