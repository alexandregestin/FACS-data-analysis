...
```{r}
sampleNames(flowset)<-c("AstroSmall","neurons","NPC","oligo","astrocyte","IPSC","NPC2","oligo2")
sampleNames(flowset)
```
###FIGURE 2-b
```{r}
...
clustering=Rphenograph_flowset(organo_transformed_flowset,colstoignore = c(1,2,9),k=200, scale = FALSE)
```
###FIGURE 3-b
```{r}
